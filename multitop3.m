[nx,ny,tol_out,tol_f,iter_max_in,iter_max_out,p,q,e,v,rf] = set_parameters ();
 multi_top(nx,ny,tol_out,tol_f,iter_max_in,iter_max_out,p,q,e,v,rf);
function [nx,ny,tol,tolf,im_in,im_out,p,q,e,v,rf] = set_parameters()
 nx = 100; ny = 100; tol = 0.001; tolf = 0.05; im_in = 2; im_out = 2000;
 p = 4; q = 3; e = [3 2 1 1e-9]'; v = [0.2 0.2 0.2 0.4]'; rf = 3;
end
function multi_top(nx,ny,tol_out,tol_f,iter_max_in,iter_max_out,p,q,e,v,rf)
 alpha = zeros(nx*ny,p);
 for i = 1:p
 alpha(:,i) = v(i);
 end
